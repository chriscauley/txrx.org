...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnsubscribeLink'
        db.create_table('membership_unsubscribelink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('membership', ['UnsubscribeLink'])

        # Adding field 'UserMembership.notify_comments'
        db.add_column('membership_usermembership', 'notify_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UnsubscribeLink'
        db.delete_table('membership_unsubscribelink')

        # Deleting field 'UserMembership.notify_comments'
        db.delete_column('membership_usermembership', 'notify_comments')
