...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MembershipFeature'
        db.create_table(u'membership_membershipfeature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.Feature'])),
            ('membership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.Membership'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'membership', ['MembershipFeature'])

        # Adding model 'MembershipGroup'
        db.create_table(u'membership_membershipgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'membership', ['MembershipGroup'])

        # Deleting field 'Feature.membership'
        db.delete_column(u'membership_feature', 'membership_id')

        # Deleting field 'Feature.order'
        db.delete_column(u'membership_feature', 'order')


    def backwards(self, orm):
        # Deleting model 'MembershipFeature'
        db.delete_table(u'membership_membershipfeature')

        # Deleting model 'MembershipGroup'
        db.delete_table(u'membership_membershipgroup')

        # Adding field 'Feature.membership'
        db.add_column(u'membership_feature', 'membership',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['membership.Membership']),
                      keep_default=False)

        # Adding field 'Feature.order'
        db.add_column(u'membership_feature', 'order',
    ...
    models = {
        ...
        u'membership.meetingminutes': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inactive_present': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'meetings_inactive'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'member_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'nonvoters_present': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'voters_present': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'ZzSHoACg967KIoibP7sQcfZD7h6GhDry'", 'max_length': '32'}),
