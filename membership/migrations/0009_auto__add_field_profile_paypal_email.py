...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.paypal_email'
        db.add_column('membership_profile', 'paypal_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Profile.paypal_email'
        db.delete_column('membership_profile', 'paypal_email')
