...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field inactive_present on 'MeetingMinutes'
        db.create_table('membership_meetingminutes_inactive_present', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meetingminutes', models.ForeignKey(orm['membership.meetingminutes'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('membership_meetingminutes_inactive_present', ['meetingminutes_id', 'user_id'])

        # Adding M2M table for field nonvoters_present on 'MeetingMinutes'
        db.create_table('membership_meetingminutes_nonvoters_present', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meetingminutes', models.ForeignKey(orm['membership.meetingminutes'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('membership_meetingminutes_nonvoters_present', ['meetingminutes_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field inactive_present on 'MeetingMinutes'
        db.delete_table('membership_meetingminutes_inactive_present')

        # Removing M2M table for field nonvoters_present on 'MeetingMinutes'
        db.delete_table('membership_meetingminutes_nonvoters_present')
