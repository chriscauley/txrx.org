...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.by_line'
        db.add_column('membership_profile', 'by_line',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Profile.by_line'
        db.delete_column('membership_profile', 'by_line')
    ...
    models = {
        ...
        'membership.profile': {
            ...
            'by_line': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
