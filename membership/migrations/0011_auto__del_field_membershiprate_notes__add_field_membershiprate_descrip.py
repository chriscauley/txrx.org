...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'MembershipRate.notes'
        db.rename_column('membership_membershiprate', 'notes', 'description')

    def backwards(self, orm):

        # Renaming field 'MembershipRate.description'
        db.rename_column('membership_membershiprate', 'description', 'notes')
