...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserMembership.bio'
        db.alter_column(u'membership_usermembership', 'bio', self.gf('wmd.models.MarkDownField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserMembership.bio'
        db.alter_column(u'membership_usermembership', 'bio', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'9m87LJHXzTXNBGzdBLyPqJDyo144Q0TD'", 'max_length': '32'}),
