...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.discount_percentage'
        db.add_column(u'membership_membership', 'discount_percentage',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.discount_percentage'
        db.delete_column(u'membership_membership', 'discount_percentage')
    ...
    models = {
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'sqGpSUknyKQUsyJIFJgsnJAZjp0uUXqd'", 'max_length': '32'}),
