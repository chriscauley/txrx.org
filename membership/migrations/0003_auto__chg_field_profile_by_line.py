...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.by_line'
        db.alter_column('membership_profile', 'by_line', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    def backwards(self, orm):

        # Changing field 'Profile.by_line'
        db.alter_column('membership_profile', 'by_line', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    models = {
        'auth.group': {
