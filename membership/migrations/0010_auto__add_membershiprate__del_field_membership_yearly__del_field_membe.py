...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MembershipRate'
        db.create_table('membership_membershiprate', (
            ...
            ('months', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('membership', ['MembershipRate'])

        # Deleting field 'Membership.yearly'
        db.delete_column('membership_membership', 'yearly')

        # Deleting field 'Membership.monthly'
        db.delete_column('membership_membership', 'monthly')

        # Deleting field 'Membership.notes'
        db.delete_column('membership_membership', 'notes')

        # Deleting field 'Membership.student_rate'
        db.delete_column('membership_membership', 'student_rate')


    def backwards(self, orm):
        # Deleting model 'MembershipRate'
        db.delete_table('membership_membershiprate')

        # Adding field 'Membership.yearly'
        db.add_column('membership_membership', 'yearly',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Membership.monthly'
        db.add_column('membership_membership', 'monthly',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Membership.notes'
        db.add_column('membership_membership', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membership.student_rate'
        db.add_column('membership_membership', 'student_rate',
    ...
    models = {
        ...
        'membership.membershiprate': {
            'Meta': {'object_name': 'MembershipRate'},
            'cost': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membership': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['membership.Membership']"}),
            'months': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        'membership.profile': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photo.Photo']", 'null': 'True', 'blank': 'True'}),
