...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.notify_classes'
        db.add_column('membership_usermembership', 'notify_classes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMembership.notify_classes'
        db.delete_column('membership_usermembership', 'notify_classes')
