...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipRate.order'
        db.add_column('membership_membershiprate', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipRate.order'
        db.delete_column('membership_membershiprate', 'order')
