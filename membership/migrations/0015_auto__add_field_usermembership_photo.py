...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.photo'
        db.add_column('membership_usermembership', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMembership.photo'
        db.delete_column('membership_usermembership', 'photo_id')
