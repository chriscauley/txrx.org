...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.api_key'
        db.add_column(u'membership_usermembership', 'api_key',
                      self.gf('django.db.models.fields.CharField')(default='XoPwlPuEiUnbhhEuMoM8u2WzHhgvef2W', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMembership.api_key'
        db.delete_column(u'membership_usermembership', 'api_key')
    ...
    models = {
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'2ip0J3CnlbARWp1urJtoX1ObXRySpzs7'", 'max_length': '32'}),
            'bio': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
