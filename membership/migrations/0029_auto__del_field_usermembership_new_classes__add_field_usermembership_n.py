...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserMembership.new_classes'
        db.delete_column('membership_usermembership', 'new_classes')

        # Adding field 'UserMembership.notify_sessions'
        db.add_column('membership_usermembership', 'notify_sessions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserMembership.new_classes'
        db.add_column('membership_usermembership', 'new_classes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UserMembership.notify_sessions'
        db.delete_column('membership_usermembership', 'notify_sessions')
