...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.membershipgroup'
        db.add_column(u'membership_membership', 'membershipgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.MembershipGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.membershipgroup'
        db.delete_column(u'membership_membership', 'membershipgroup_id')
    ...
    models = {
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'8qtqwNAeBKQgaYGD1hv1DPXde9lnTZnw'", 'max_length': '32'}),
