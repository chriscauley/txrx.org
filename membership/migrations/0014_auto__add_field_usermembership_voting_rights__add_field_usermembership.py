...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.voting_rights'
        db.add_column('membership_usermembership', 'voting_rights',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserMembership.suspended'
        db.add_column('membership_usermembership', 'suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'UserMembership.photo'
        db.alter_column('membership_usermembership', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True))

    def backwards(self, orm):
        # Deleting field 'UserMembership.voting_rights'
        db.delete_column('membership_usermembership', 'voting_rights')

        # Deleting field 'UserMembership.suspended'
        db.delete_column('membership_usermembership', 'suspended')


        # Changing field 'UserMembership.photo'
        db.alter_column('membership_usermembership', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.Photo'], null=True))
