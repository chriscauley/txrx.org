...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MeetingMinutes', fields ['date']
        db.create_unique('membership_meetingminutes', ['date'])


    def backwards(self, orm):
        # Removing unique constraint on 'MeetingMinutes', fields ['date']
        db.delete_unique('membership_meetingminutes', ['date'])
