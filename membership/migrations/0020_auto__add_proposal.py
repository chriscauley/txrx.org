...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('membership_proposal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meeting_minutes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.MeetingMinutes'])),
            ('original', self.gf('wmd.models.MarkDownField')()),
            ('ammended', self.gf('wmd.models.MarkDownField')(null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('membership', ['Proposal'])


    def backwards(self, orm):
        # Deleting model 'Proposal'
        db.delete_table('membership_proposal')
