...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field voters_present on 'MeetingMinutes'
        db.create_table('membership_meetingminutes_voters_present', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meetingminutes', models.ForeignKey(orm['membership.meetingminutes'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('membership_meetingminutes_voters_present', ['meetingminutes_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field voters_present on 'MeetingMinutes'
        db.delete_table('membership_meetingminutes_voters_present')
    ...
    models = {
        ...
        'membership.meetingminutes': {
            ...
            'voters_present': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
