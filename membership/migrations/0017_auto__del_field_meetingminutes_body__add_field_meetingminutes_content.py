...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeetingMinutes.body'
        db.delete_column('membership_meetingminutes', 'body')

        # Adding field 'MeetingMinutes.content'
        db.add_column('membership_meetingminutes', 'content',
                      self.gf('wmd.models.MarkDownField')(default='arst'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MeetingMinutes.body'
        db.add_column('membership_meetingminutes', 'body',
                      self.gf('wmd.models.MarkDownField')(default='arst'),
                      keep_default=False)

        # Deleting field 'MeetingMinutes.content'
        db.delete_column('membership_meetingminutes', 'content')
