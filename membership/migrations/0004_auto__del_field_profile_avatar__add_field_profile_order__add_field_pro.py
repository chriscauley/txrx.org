...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('membership_profile', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photo.Photo']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Profile.avatar'
        db.add_column('membership_profile', 'avatar',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=300, null=True, blank=True),
                      keep_default=False)
        ...
        db.delete_column('membership_profile', 'photo_id')
