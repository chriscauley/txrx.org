...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.safety'
        db.add_column(u'membership_usermembership', 'safety',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserMembership.rfid'
        db.add_column(u'membership_usermembership', 'rfid',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMembership.safety'
        db.delete_column(u'membership_usermembership', 'safety')

        # Deleting field 'UserMembership.rfid'
        db.delete_column(u'membership_usermembership', 'rfid')
    ...
    models = {
        ...
        u'membership.usermembership': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'23sl0t5g6ce1ZGiMQI0sZKZD5JnMjbBL'", 'max_length': '32'}),
            ...
            'rfid': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
