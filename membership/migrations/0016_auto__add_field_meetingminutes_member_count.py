...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.member_count'
        db.add_column('membership_meetingminutes', 'member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.member_count'
        db.delete_column('membership_meetingminutes', 'member_count')
