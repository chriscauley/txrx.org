...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Officer.order'
        db.add_column('membership_officer', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Officer.order'
        db.delete_column('membership_officer', 'order')
    ...
    models = {
        ...
        'membership.officer': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Officer'},
