...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LimitedAccessKey'
        db.create_table('membership_limitedaccesskey', (
        ...
        db.send_create_signal('membership', ['LimitedAccessKey'])


    def backwards(self, orm):
        # Deleting model 'LimitedAccessKey'
        db.delete_table('membership_limitedaccesskey')
