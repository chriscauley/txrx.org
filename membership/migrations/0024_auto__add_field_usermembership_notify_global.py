...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMembership.notify_global'
        db.add_column('membership_usermembership', 'notify_global',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMembership.notify_global'
        db.delete_column('membership_usermembership', 'notify_global')
