...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'course_session', 'section_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'course_section', (
            ...
            ('no_conflict', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('max_students', self.gf('django.db.models.fields.IntegerField')(default=16)),
            ('src', self.gf(u'sorl.thumbnail.fields.ImageField')(max_length=300, null=True, blank=True)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Term'])),
            ('fee', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('requirements', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['geo.Room'])),
            ('prerequisites', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('safety', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'course', ['Section'])

        # Adding field 'Session.section'
        db.add_column(u'course_session', 'section',
