...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_evaluation', (
            ...
            ('presentation', self.gf('django.db.models.fields.IntegerField')()),
            ('presentation_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.IntegerField')()),
            ('content_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('visuals', self.gf('django.db.models.fields.IntegerField')()),
            ('visuals_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('question1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('question2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('question3', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('question4', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('course', ['Evaluation'])

        # Adding field 'Enrollment.evaluated'
        db.add_column('course_enrollment', 'evaluated',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('course_evaluation')

        # Deleting field 'Enrollment.evaluated'
        db.delete_column('course_enrollment', 'evaluated')
