...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseSubscription'
        db.create_table('course_coursesubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Course'])),
        ))
        db.send_create_signal('course', ['CourseSubscription'])


    def backwards(self, orm):
        # Deleting model 'CourseSubscription'
        db.delete_table('course_coursesubscription')
