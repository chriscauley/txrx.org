...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.requirements'
        db.add_column('course_section', 'requirements',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Section.prerequisites'
        db.add_column('course_section', 'prerequisites',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Section.requirements'
        db.delete_column('course_section', 'requirements')

        # Deleting field 'Section.prerequisites'
        db.delete_column('course_section', 'prerequisites')
    ...
    models = {
        ...
        'course.session': {
            ...
            'time_string': ('django.db.models.fields.CharField', [], {'default': "'not implimented'", 'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'course.subject': {
