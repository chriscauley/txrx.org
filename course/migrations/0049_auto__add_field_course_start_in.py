...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.start_in'
        db.add_column(u'course_course', 'start_in',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='starting_courses', null=True, to=orm['geo.Room']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.start_in'
        db.delete_column(u'course_course', 'start_in_id')
