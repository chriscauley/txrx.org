...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseCompletion.created'
        db.add_column('course_coursecompletion', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseCompletion.created'
        db.delete_column('course_coursecompletion', 'created')
