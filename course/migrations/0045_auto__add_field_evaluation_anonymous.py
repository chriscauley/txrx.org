...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluation.anonymous'
        db.add_column(u'course_evaluation', 'anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.anonymous'
        db.delete_column(u'course_evaluation', 'anonymous')
