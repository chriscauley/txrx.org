...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enrollment.completed'
        db.add_column('course_enrollment', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enrollment.completed'
        db.delete_column('course_enrollment', 'completed')
