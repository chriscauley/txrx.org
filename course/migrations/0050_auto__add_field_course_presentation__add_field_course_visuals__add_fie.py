...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.presentation'
        db.add_column(u'course_course', 'presentation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Course.visuals'
        db.add_column(u'course_course', 'visuals',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Course.content'
        db.add_column(u'course_course', 'content',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.presentation'
        db.delete_column(u'course_course', 'presentation')

        # Deleting field 'Course.visuals'
        db.delete_column(u'course_course', 'visuals')

        # Deleting field 'Course.content'
        db.delete_column(u'course_course', 'content')
    ...
    models = {
        ...
        u'course.course': {
            ...
            'content': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'presentation': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geo.Room']"}),
            ...
            'start_in': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'starting_courses'", 'null': 'True', 'to': u"orm['geo.Room']"}),
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['course.Subject']", 'symmetrical': 'False'}),
            'visuals': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        u'course.evaluation': {
            ...
            'content': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'presentation': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user.User']"}),
            'visuals': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
