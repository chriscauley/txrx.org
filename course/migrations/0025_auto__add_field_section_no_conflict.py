...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.no_conflict'
        db.add_column(u'course_section', 'no_conflict',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.no_conflict'
        db.delete_column(u'course_section', 'no_conflict')
