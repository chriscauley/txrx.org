...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseCompletion'
        db.create_table('course_coursecompletion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Course'])),
        ))
        db.send_create_signal('course', ['CourseCompletion'])


    def backwards(self, orm):
        # Deleting model 'CourseCompletion'
        db.delete_table('course_coursecompletion')
