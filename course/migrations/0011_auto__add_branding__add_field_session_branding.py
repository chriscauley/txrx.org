...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_branding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('small_image_override', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('course', ['Branding'])

        # Adding field 'Session.branding'
        db.add_column('course_session', 'branding',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Branding'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Branding'
        db.delete_table('course_branding')

        # Deleting field 'Session.branding'
        db.delete_column('course_session', 'branding_id')
    ...
    models = {
        ...
        'course.enrollment': {
            'Meta': {'ordering': "('-datetime', '-id')", 'object_name': 'Enrollment'},
