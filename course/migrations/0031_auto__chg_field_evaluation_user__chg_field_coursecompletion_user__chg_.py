...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evaluation.user'
        db.alter_column(u'course_evaluation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

        # Changing field 'CourseCompletion.user'
        db.alter_column(u'course_coursecompletion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

        # Changing field 'Enrollment.user'
        db.alter_column(u'course_enrollment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

        # Changing field 'Session.user'
        db.alter_column(u'course_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

        # Changing field 'CourseSubscription.user'
        db.alter_column(u'course_coursesubscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'Evaluation.user'
        db.alter_column(u'course_evaluation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'CourseCompletion.user'
        db.alter_column(u'course_coursecompletion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Enrollment.user'
        db.alter_column(u'course_enrollment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Session.user'
        db.alter_column(u'course_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'CourseSubscription.user'
        db.alter_column(u'course_coursesubscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
