...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.fee'
        db.add_column(u'course_course', 'fee',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.fee_notes'
        db.add_column(u'course_course', 'fee_notes',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements'
        db.add_column(u'course_course', 'requirements',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.prerequisites'
        db.add_column(u'course_course', 'prerequisites',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Course.safety'
        db.add_column(u'course_course', 'safety',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.room'
        db.add_column(u'course_course', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['geo.Room']),
                      keep_default=False)

        # Adding field 'Course.no_conflict'
        db.add_column(u'course_course', 'no_conflict',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.max_students'
        db.add_column(u'course_course', 'max_students',
                      self.gf('django.db.models.fields.IntegerField')(default=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.fee'
        db.delete_column(u'course_course', 'fee')

        # Deleting field 'Course.fee_notes'
        db.delete_column(u'course_course', 'fee_notes')

        # Deleting field 'Course.requirements'
        db.delete_column(u'course_course', 'requirements')

        # Deleting field 'Course.prerequisites'
        db.delete_column(u'course_course', 'prerequisites')

        # Deleting field 'Course.description'
        db.delete_column(u'course_course', 'description')

        # Deleting field 'Course.safety'
        db.delete_column(u'course_course', 'safety')

        # Deleting field 'Course.room'
        db.delete_column(u'course_course', 'room_id')

        # Deleting field 'Course.no_conflict'
        db.delete_column(u'course_course', 'no_conflict')

        # Deleting field 'Course.max_students'
        db.delete_column(u'course_course', 'max_students')
    ...
    models = {
        ...
        u'course.session': {
            'Meta': {'ordering': "('first_date',)", 'object_name': 'Session'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
