...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evaluation.presentation_comments'
        db.alter_column(u'course_evaluation', 'presentation_comments', self.gf('django.db.models.fields.TextField')(max_length=512, null=True))

        # Changing field 'Evaluation.visuals_comments'
        db.alter_column(u'course_evaluation', 'visuals_comments', self.gf('django.db.models.fields.TextField')(max_length=512, null=True))

        # Changing field 'Evaluation.content_comments'
        db.alter_column(u'course_evaluation', 'content_comments', self.gf('django.db.models.fields.TextField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'Evaluation.presentation_comments'
        db.alter_column(u'course_evaluation', 'presentation_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Evaluation.visuals_comments'
        db.alter_column(u'course_evaluation', 'visuals_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Evaluation.content_comments'
        db.alter_column(u'course_evaluation', 'content_comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        u'course.sessionattachment': {
            ...
            'attachment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['codrspace.MiscFile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
