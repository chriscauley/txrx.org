...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enrollment.evaluation_date'
        db.add_column('course_enrollment', 'evaluation_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Enrollment.evaluation_date'
        db.delete_column('course_enrollment', 'evaluation_date')
