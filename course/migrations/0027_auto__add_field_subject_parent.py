...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'course_subject', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Subject'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subject.parent'
        db.delete_column(u'course_subject', 'parent_id')
