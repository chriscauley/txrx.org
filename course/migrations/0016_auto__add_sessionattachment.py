...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionAttachment'
        db.create_table('course_sessionattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Session'])),
            ('attachment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.MiscFile'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('course', ['SessionAttachment'])


    def backwards(self, orm):
        # Deleting model 'SessionAttachment'
        db.delete_table('course_sessionattachment')
    ...
    models = {
        ...
        'course.sessionattachment': {
            'Meta': {'ordering': "('order',)", 'object_name': 'SessionAttachment'},
            'attachment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codrspace.MiscFile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
