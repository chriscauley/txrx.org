...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.reschedule_on'
        db.alter_column(u'course_course', 'reschedule_on', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Course.reschedule_on'
        db.alter_column(u'course_course', 'reschedule_on', self.gf('django.db.models.fields.DateTimeField')())
