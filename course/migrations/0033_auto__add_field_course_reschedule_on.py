...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.reschedule_on'
        db.add_column(u'course_course', 'reschedule_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.reschedule_on'
        db.delete_column(u'course_course', 'reschedule_on')
    ...
    models = {
        ...
        u'course.course': {
            ...
            'reschedule_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
