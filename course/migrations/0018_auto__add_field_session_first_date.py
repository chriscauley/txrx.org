...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.first_date'
        db.add_column('course_session', 'first_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)
        from course.models import Session
        [s.save() for s in Session.objects.all()]

    def backwards(self, orm):
        # Deleting field 'Session.first_date'
        db.delete_column('course_session', 'first_date')
