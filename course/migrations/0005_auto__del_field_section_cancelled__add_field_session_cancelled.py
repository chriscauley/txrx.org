...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.cancelled'
        db.add_column('course_session', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Section.cancelled'
        db.add_column('course_section', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Session.cancelled'
        db.delete_column('course_session', 'cancelled')
