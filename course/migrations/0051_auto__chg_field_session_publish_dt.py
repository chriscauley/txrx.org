...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.publish_dt'
        db.alter_column(u'course_session', 'publish_dt', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Session.publish_dt'
        db.alter_column(u'course_session', 'publish_dt', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'course.session': {
            ...
            'publish_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
