...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.course'
        db.add_column(u'course_session', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Course'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Course.src'
        db.delete_column(u'course_course', 'src')


    def backwards(self, orm):
        # Deleting field 'Session.course'
        db.delete_column(u'course_session', 'course_id')

        # Adding field 'Course.src'
        db.add_column(u'course_course', 'src',
                      self.gf(u'sorl.thumbnail.fields.ImageField')(max_length=300, null=True, blank=True),
                      keep_default=False)
