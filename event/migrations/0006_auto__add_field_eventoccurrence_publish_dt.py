...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventOccurrence.publish_dt'
        db.add_column('event_eventoccurrence', 'publish_dt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventOccurrence.publish_dt'
        db.delete_column('event_eventoccurrence', 'publish_dt')
