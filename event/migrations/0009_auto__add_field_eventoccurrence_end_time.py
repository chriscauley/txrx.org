...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventOccurrence.end_time'
        db.add_column(u'event_eventoccurrence', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventOccurrence.end_time'
        db.delete_column(u'event_eventoccurrence', 'end_time')
