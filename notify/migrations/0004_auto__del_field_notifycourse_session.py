...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NotifyCourse.session'
        db.delete_column(u'notify_notifycourse', 'session_id')


    def backwards(self, orm):
        # Adding field 'NotifyCourse.session'
        db.add_column(u'notify_notifycourse', 'session',
