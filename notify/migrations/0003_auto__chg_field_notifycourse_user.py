...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotifyCourse.user'
        db.alter_column(u'notify_notifycourse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'NotifyCourse.user'
        db.alter_column(u'notify_notifycourse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
