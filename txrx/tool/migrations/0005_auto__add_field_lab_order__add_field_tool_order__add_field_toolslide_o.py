...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.order'
        db.add_column('tool_lab', 'order', self.gf('django.db.models.fields.IntegerField')(default=9999), keep_default=False)

        # Adding field 'Tool.order'
        db.add_column('tool_tool', 'order', self.gf('django.db.models.fields.IntegerField')(default=9999), keep_default=False)

        # Adding field 'ToolSlide.order'
        db.add_column('tool_toolslide', 'order', self.gf('django.db.models.fields.IntegerField')(default=9999), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.order'
        db.delete_column('tool_lab', 'order')

        # Deleting field 'Tool.order'
        db.delete_column('tool_tool', 'order')

        # Deleting field 'ToolSlide.order'
        db.delete_column('tool_toolslide', 'order')
    ...
    models = {
        ...
        'tool.toolslide': {
            'Meta': {'ordering': "('order',)", 'object_name': 'ToolSlide', '_ormbases': ['photo.Photo']},
            'order': ('django.db.models.fields.IntegerField', [], {'default': '9999'}),
