...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.lab'
        db.add_column('tool_tool', 'lab', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tool.Lab']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tool.lab'
        db.delete_column('tool_tool', 'lab_id')
