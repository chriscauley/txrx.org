...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.cancelled'
        db.add_column('course_section', 'cancelled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Section.full'
        db.add_column('course_section', 'full', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.cancelled'
        db.delete_column('course_section', 'cancelled')

        # Deleting field 'Section.full'
        db.delete_column('course_section', 'full')
