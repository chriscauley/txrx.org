...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('membership_profile', 'bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Profile.avatar'
        db.add_column('membership_profile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.bio'
        db.delete_column('membership_profile', 'bio')

        # Deleting field 'Profile.avatar'
        db.delete_column('membership_profile', 'avatar')
