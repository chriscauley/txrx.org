...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.ghandle'
        db.delete_column('membership_profile', 'ghandle')


    def backwards(self, orm):
        
        # Adding field 'Profile.ghandle'
        db.add_column('membership_profile', 'ghandle', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
