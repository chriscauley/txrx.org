...
<session-list>
  ...
  <div class="session well" id="s{ id }" each={ opts.active_sessions }>
    ...
    <b class="full" if={ closed_status == 'cancelled' }>This session has been canceled. If you were enrolled and haven not heard from us please email <a href="{ uR.config.support_email }">{ uR.config.support_email }</a></b>
