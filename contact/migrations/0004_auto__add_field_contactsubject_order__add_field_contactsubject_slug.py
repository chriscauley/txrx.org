...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactSubject.order'
        db.add_column(u'contact_contactsubject', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=9999),
                      keep_default=False)

        # Adding field 'ContactSubject.slug'
        db.add_column(u'contact_contactsubject', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='arst', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactSubject.order'
        db.delete_column(u'contact_contactsubject', 'order')

        # Deleting field 'ContactSubject.slug'
        db.delete_column(u'contact_contactsubject', 'slug')
    ...
    models = {
        ...
        u'contact.contactsubject': {
            'Meta': {'ordering': "('order',)", 'object_name': 'ContactSubject'},
