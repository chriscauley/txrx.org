...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('codrspace_taggedfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.MiscFile'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=9999)),
        ))
        db.send_create_signal('codrspace', ['TaggedFile'])


    def backwards(self, orm):
        # Deleting model 'TaggedFile'
        db.delete_table('codrspace_taggedfile')
    ...
    models = {
        ...
        'codrspace.photosetconnection': {
            'Meta': {'unique_together': "(('content_type', 'object_id'),)", 'object_name': 'PhotoSetConnection'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'codrspace.taggedfile': {
            'Meta': {'object_name': 'TaggedFile'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'file': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codrspace.MiscFile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '9999'})
        },
        'codrspace.taggedphoto': {
