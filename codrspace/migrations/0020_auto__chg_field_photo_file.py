...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('codrspace_photo', 'file', self.gf('crop_override.field.OriginalImage')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.file'
        db.alter_column('codrspace_photo', 'file', self.gf('crop_override.field.OriginalImage')(max_length=100, null=True))
