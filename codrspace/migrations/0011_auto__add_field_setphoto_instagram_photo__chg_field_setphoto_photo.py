...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetPhoto.instagram_photo'
        db.add_column('codrspace_setphoto', 'instagram_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instagram.InstagramPhoto'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'SetPhoto.photo'
        db.alter_column('codrspace_setphoto', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True))

    def backwards(self, orm):
        # Deleting field 'SetPhoto.instagram_photo'
        db.delete_column('codrspace_setphoto', 'instagram_photo_id')


        # User chose to not deal with backwards NULL issues for 'SetPhoto.photo'
        raise RuntimeError("Cannot reverse this migration. 'SetPhoto.photo' and its values cannot be restored.")
    ...
    models = {
        ...
        'codrspace.setphoto': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instagram_photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['instagram.InstagramPhoto']", 'null': 'True', 'blank': 'True'}),
