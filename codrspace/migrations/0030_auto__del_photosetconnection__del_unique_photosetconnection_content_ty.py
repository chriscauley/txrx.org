...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PhotoSetConnection', fields ['content_type', 'object_id']
        db.delete_unique(u'codrspace_photosetconnection', ['content_type_id', 'object_id'])

        # Deleting model 'PhotoSetConnection'
        db.delete_table(u'codrspace_photosetconnection')

        # Deleting model 'SetPhoto'
        db.delete_table(u'codrspace_setphoto')

        # Deleting model 'PhotoSet'
        db.delete_table(u'codrspace_photoset')

        # Adding field 'Photo.external_url'
        db.add_column(u'codrspace_photo', 'external_url',
    ...
    def backwards(self, orm):
        # Adding model 'PhotoSetConnection'
        db.create_table(u'codrspace_photosetconnection', (
        ...
        db.send_create_signal('codrspace', ['PhotoSetConnection'])

        # Adding unique constraint on 'PhotoSetConnection', fields ['content_type', 'object_id']
        db.create_unique(u'codrspace_photosetconnection', ['content_type_id', 'object_id'])

        # Adding model 'SetPhoto'
        db.create_table(u'codrspace_setphoto', (
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True, blank=True)),
            ('photoset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.PhotoSet'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'codrspace_photoset', (
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True, blank=True)),
        ...
        # Deleting field 'Photo.external_url'
        db.delete_column(u'codrspace_photo', 'external_url')
    ...
    models = {
        ...
        u'codrspace.photo': {
            ...
            'external_type': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
