...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Post.author'
        db.rename_column('codrspace_post', 'author_id', 'user_id')

        # Adding unique constraint on 'Post', fields ['slug', 'user']
        db.create_unique('codrspace_post', ['slug', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Post', fields ['slug', 'user']
        db.delete_unique('codrspace_post', ['slug', 'user_id'])

        # Renaming field 'Post.user'
        db.rename_column('codrspace_post', 'user_id', 'author_id')
