...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.uploader'
        db.add_column('codrspace_media', 'uploader',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.uploader'
        db.delete_column('codrspace_media', 'uploader_id')
    ...
    models = {
        ...
        'codrspace.post': {
            'Meta': {'ordering': "('-publish_dt',)", 'unique_together': "(('slug', 'author'),)", 'object_name': 'Post'},
