...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PhotoSetConnection', fields ['object_id', 'content_type']
        db.create_unique('codrspace_photosetconnection', ['object_id', 'content_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoSetConnection', fields ['object_id', 'content_type']
        db.delete_unique('codrspace_photosetconnection', ['object_id', 'content_type_id'])
