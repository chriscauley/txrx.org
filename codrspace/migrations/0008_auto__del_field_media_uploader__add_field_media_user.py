...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Media.uploader'
        db.rename_column('codrspace_media', 'uploader_id','user_id')

    def backwards(self, orm):
        # Renaming field 'Media.user'
        db.rename_column('codrspace_media', 'user_id','uploader_id')
