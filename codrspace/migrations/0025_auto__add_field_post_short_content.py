...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.short_content'
        db.add_column('codrspace_post', 'short_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.short_content'
        db.delete_column('codrspace_post', 'short_content')
