...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.instagramphoto'
        db.add_column('codrspace_photo', 'instagramphoto',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.instagramphoto'
        db.delete_column('codrspace_photo', 'instagramphoto_id')
