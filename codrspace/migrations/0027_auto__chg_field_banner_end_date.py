...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Banner.end_date'
        db.alter_column('codrspace_banner', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2099, 1, 1, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Banner.end_date'
        db.alter_column('codrspace_banner', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))
