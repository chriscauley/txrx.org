...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.header'
        db.add_column('codrspace_banner', 'header',
                      self.gf('django.db.models.fields.CharField')(default='Featured Event', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Banner.header'
        db.delete_column('codrspace_banner', 'header')
