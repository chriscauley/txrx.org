...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.source'
        db.add_column('codrspace_photo', 'source',
                      self.gf('django.db.models.fields.CharField')(default='web', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.source'
        db.delete_column('codrspace_photo', 'source')
