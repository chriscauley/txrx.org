...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('feed', ['Thing'])

        # Adding field 'FeedItem.get_absolute_url'
        db.add_column('feed_feeditem', 'get_absolute_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('feed_thing')

        # Deleting field 'FeedItem.get_absolute_url'
        db.delete_column('feed_feeditem', 'get_absolute_url')
