...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feed_feeditem', (
            ...
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(default='feed_thumbnails/default.png', max_length=100)),
            ...
            ('get_absolute_url', self.gf('django.db.models.fields.CharField')(max_length=256)),
