...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.first_date'
        db.alter_column('chores_task', 'first_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 31, 14, 44, 38, 613402)))


    def backwards(self, orm):
        
        # Changing field 'Task.first_date'
        db.alter_column('chores_task', 'first_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'chores.taskoccurrence': {
            'Meta': {'ordering': "('due_date',)", 'object_name': 'TaskOccurrence'},
