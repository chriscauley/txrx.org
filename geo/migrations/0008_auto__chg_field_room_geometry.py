...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Room.geometry'
        db.alter_column(u'geo_room', 'geometry', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Room.geometry'
        db.alter_column(u'geo_room', 'geometry', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
