...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DXFEntity'
        db.create_table(u'geo_dxfentity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('points', self.gf('django.db.models.fields.TextField')()),
            ('dxftype', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Room'], null=True, blank=True)),
        ))
        db.send_create_signal(u'geo', ['DXFEntity'])


    def backwards(self, orm):
        # Deleting model 'DXFEntity'
        db.delete_table(u'geo_dxfentity')
