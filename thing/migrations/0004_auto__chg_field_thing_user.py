...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thing.user'
        db.alter_column(u'thing_thing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'Thing.user'
        db.alter_column(u'thing_thing', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
