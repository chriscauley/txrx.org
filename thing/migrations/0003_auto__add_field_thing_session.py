...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thing.session'
        db.add_column(u'thing_thing', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Session'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thing.session'
        db.delete_column(u'thing_thing', 'session_id')
