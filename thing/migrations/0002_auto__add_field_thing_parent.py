...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thing.parent'
        db.add_column('thing_thing', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Thing'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thing.parent'
        db.delete_column('thing_thing', 'parent_id')
    ...
    models = {
        ...
        'thing.thing': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Thing']", 'null': 'True', 'blank': 'True'}),
