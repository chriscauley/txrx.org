...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tool_lab', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Media'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lab.description'
        db.add_column('tool_lab', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tool_lab', 'photo_id')

        # Deleting field 'Lab.description'
        db.delete_column('tool_lab', 'description')
