...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tool_lab', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Photo'], null=True))

    def backwards(self, orm):

        # Changing field 'Lab.photo'
        db.alter_column(u'tool_lab', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True))
