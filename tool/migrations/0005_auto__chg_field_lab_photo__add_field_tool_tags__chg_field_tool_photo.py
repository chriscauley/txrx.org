...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tool_lab', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True))
        # Adding field 'Tool.tags'
        db.add_column('tool_tool', 'tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)


        # Changing field 'Tool.photo'
        db.alter_column('tool_tool', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True))

    def backwards(self, orm):

        # Changing field 'Lab.photo'
        db.alter_column('tool_lab', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Media'], null=True))
        # Deleting field 'Tool.tags'
        db.delete_column('tool_tool', 'tags')


        # Changing field 'Tool.photo'
        db.alter_column('tool_tool', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Media'], null=True))
