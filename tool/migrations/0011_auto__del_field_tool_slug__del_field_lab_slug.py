...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tool_tool', 'slug')

        # Deleting field 'Lab.slug'
        db.delete_column(u'tool_lab', 'slug')


    def backwards(self, orm):
        # Adding field 'Tool.slug'
        db.add_column(u'tool_tool', 'slug',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lab.slug'
        db.add_column(u'tool_lab', 'slug',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True, blank=True),
                      keep_default=False)
