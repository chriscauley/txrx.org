...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.certification'
        db.add_column(u'tool_tool', 'certification',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tool.ToolCertification'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ToolCertification.tool'
        db.delete_column(u'tool_toolcertification', 'tool_id')


    def backwards(self, orm):
        # Deleting field 'Tool.certification'
        db.delete_column(u'tool_tool', 'certification_id')

        # Adding field 'ToolCertification.tool'
        db.add_column(u'tool_toolcertification', 'tool',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tool.Tool']),
                      keep_default=False)
    ...
    models = {
        ...
        u'tool.tool': {
            'Meta': {'ordering': "('lab', 'order')", 'object_name': 'Tool'},
            'certification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tool.ToolCertification']", 'null': 'True', 'blank': 'True'}),
            ...
            'functional': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '99999'}),
            'repair_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geo.Room']", 'null': 'True', 'blank': 'True'})
        },
        u'tool.toolcertification': {
            'Meta': {'object_name': 'ToolCertification'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
