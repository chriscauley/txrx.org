...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ToolCertification'
        db.create_table(u'tool_toolcertification', (
            ...
            ('waiver', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Room'])),
        ))
        db.send_create_signal(u'tool', ['ToolCertification'])


    def backwards(self, orm):
        # Deleting model 'ToolCertification'
        db.delete_table(u'tool_toolcertification')
