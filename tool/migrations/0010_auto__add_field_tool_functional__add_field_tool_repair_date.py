...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.functional'
        db.add_column(u'tool_tool', 'functional',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Tool.repair_date'
        db.add_column(u'tool_tool', 'repair_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tool.functional'
        db.delete_column(u'tool_tool', 'functional')

        # Deleting field 'Tool.repair_date'
        db.delete_column(u'tool_tool', 'repair_date')
