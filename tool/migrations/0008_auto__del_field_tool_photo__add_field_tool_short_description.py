...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tool.photo'
        db.delete_column(u'tool_tool', 'photo_id')
    ...
    def backwards(self, orm):
        # Adding field 'Tool.photo'
        db.add_column(u'tool_tool', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codrspace.Photo'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tool.tool': {
            ...
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '99999'}),
            'short_description': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
